...
class Main {  
  ...
  public static void main(String[] args){ 
    ...
    while (inLoop == true){ 
      ...
      // Print Title
      typewriter("░█▀▀█ █▀▀▄ █░░█ █▀▀ █▀▀ █░█ █ █▀▀ 　 ▒█▀▀█ █▀▀ █▀▀█ █░░ █▀▄▀█\n▒█▄▄█ █▀▀▄ █▀▀█ █▀▀ █▀▀ █▀▄ ░ ▀▀█ 　 ▒█▄▄▀ █▀▀ █▄▄█ █░░ █░▀░█\n▒█░▒█ ▀▀▀░ ▀░░▀ ▀▀▀ ▀▀▀ ▀░▀ ░ ▀▀▀ 　 ▒█░▒█ ▀▀▀ ▀░░▀ ▀▀▀ ▀░░░▀", 0.025, false);
      print("The Movie: The Game: The Netflix Original Adaptation: The Video Game Adaptation: Text Adventure Edition v1.20 The Jaggedinksi Update\n\n");
      deciWait(1.2);
      ...
      wait(5);
      print("\n\n\033[38;5;123;1mA Cool AF™ Production \"Flying too close to the sun\"™ - © 2022 All™ Rights™ Reserved™\n\n\033[0m");
      // Give options
